export const destinations = [
  // HAUTES TERRES CENTRALES
  {
    ...
    type: "city",
    description:
      "Capitale de Madagascar, Palais de la Reine, marché d'Analakely",
    highlights: ["Palais de la Reine", "Marché d'Analakely", "Lac Anosy"],
  },
  {
    name: "Antsirabe",
    region: "Hautes Terres Centrales",
    ...
    type: "city",
    description:
      "Ville d'eaux thermales, pousse-pousse colorés, artisanat local",
  ...
  },
  {
    ...
    code: "TRI",
    type: "nature",
    description: "Lac volcanique sacré aux eaux bleu-vert",
    highlights: ["Lac volcanique", "Légendes locales", "Randonnée"],
  },
  {
    name: "Betafo",
    region: "Hautes Terres Centrales",
  ...
  },
  {
    ...
    highlights: ["Lémuriens macaco", "Artisanat", "Plages sauvages"],
  },
  {
    name: "Nosy Tanikely",
    region: "Nord",
    ...
    highlights: ["Réserve marine", "Snorkeling", "Tortues"],
  },
  {
    name: "Joffreville",
    region: "Nord",
    ...
    type: "city",
    description:
      "Station d'altitude, air frais, porte d'entrée de Montagne d'Ambre",
  ...
  },
  {
    ...
    highlights: ["Phare", "Point le plus nord", "Paysages côtiers"],
  },
  {
    ...
    highlights: ["Plages désertes", "Windsurf", "Eaux turquoise"],
  },
  ...
  // REGION EST
  {
    ...
    highlights: ["Indri indri", "Chants des lémuriens", "Orchidées rares"],
  },
  {
  ...
  },
  {
    ...
    highlights: ["Port principal", "Marché aux épices", "Plage de Foulpointe"],
  },
  {
  ...
  },
  {
    ...
    highlights: ["Plages de sable blanc", "Cocotiers", "Détente"],
  },
  {
    name: "Maroantsetra",
    region: "Est",
    ...
    highlights: ["Base pour Masoala", "Parc marin", "Biodiversité"],
  },
  {
    ...
    highlights: ["Forêt primaire", "Parc marin", "Aye-aye"],
  },
  {
    name: "Île aux Nattes",
    region: "Est",
  ...
  },
  {
    ...
    highlights: ["Tsingy géants", "Via ferrata", "Patrimoine UNESCO"],
  },
  {
    name: "Bekopaka",
    region: "Ouest",
    ...
    highlights: ["Base pour Tsingy", "Rivière Manambolo", "Grottes"],
  },
  {
  ...
  },
  {
    ...
    highlights: ["Lac Ravelobe", "Oiseaux endémiques", "Forêt sèche"],
  },
  {
    ...
    highlights: ["Baobabs entrelacés", "Légende d'amour", "Romantisme"],
  },
  {
    name: "Cirque Rouge",
    region: "Ouest",
    ...
    highlights: ["Terre rouge", "Paysage lunaire", "Géologie unique"],
  },
  ...
  // REGION SUD-OUEST
  {
    ...
    type: "park",
    description:
      "Massif gréseux, canyons, piscines naturelles, lémuriens catta",
    highlights: [
  ...
  },
  {
    ...
    highlights: ["Culture Vezo", "Marché de coquillages", "Plages"],
  },
  {
    name: "Ifaty",
    region: "Sud-Ouest",
    ...
    highlights: ["Plages de sable blanc", "Forêt de baobabs", "Plongée"],
  },
  {
    name: "Anakao",
    region: "Sud-Ouest",
    ...
    type: "beach",
    description:
      "Village de pêcheurs Vezo, plages désertes, voile traditionnelle",
  ...
  },
  {
    ...
    highlights: ["Oiseaux rares", "Forêt de transition", "Biodiversité"],
  },
  {
    ...
    type: "reserve",
    description:
      "Forêt galerie, lémuriens, forêt d'épineux, observation facilitée",
    highlights: ["Lémuriens catta", "Sifakas", "Observation rapprochée"],
  },
  {
  ...
  // REGION SUD-EST
  {
    ...
    highlights: ["Lémuriens dorés", "Sources chaudes", "Biodiversité"],
  },
  {
    name: "Fianarantsoa",
    region: "Sud-Est",
  ...
  },
  {
    ...
    highlights: ["Papier antemoro", "Marché aux zébus", "Soie sauvage"],
  },
  {
    ...
    highlights: ["Pic Boby", "Randonnées", "Paysages alpins"],
  },
  {
    ...
    type: "reserve",
    description:
      "Lémuriens catta en liberté, rochers sacrés, communauté locale",
    highlights: ["Lémuriens catta", "Rochers sacrés", "Tourisme communautaire"],
  },
  {
    name: "Manakara",
    region: "Sud-Est",
    ...
    highlights: ["Train FCE", "Canal", "Plages de l'océan Indien"],
  },
  ...
  // REGION NORD-OUEST
  {
    ...
    highlights: ["Plongée sous-marine", "Tortues", "Archipel sauvage"],
  },
  {
    name: "Nosy Iranja",
    region: "Nord-Ouest",
  ...
  // REGION NORD-EST
  {
    ...
    highlights: ["Vanille", "Plantations", "Région SAVA"],
  },
  {
    name: "Vohémar",
    region: "Nord-Est",
    ...
    highlights: ["Histoire arabe", "Plages sauvages", "Culture métissée"],
  },
  {
    name: "Cap Masoala",
    region: "Nord-Est",
    ...
    highlights: ["Nature vierge", "Biodiversité", "Isolement"],
  },
  ...
  // DESTINATIONS SPECIALES
  {
    ...
    highlights: ["Tsingy du nord", "Grottes", "Rivières souterraines"],
  },
  {
    ...
    highlights: ["Forêt sèche", "Baobabs géants", "Fossa (prédateur)"],
  },
  {
    ...
    highlights: ["Forêt de nuages", "Sifaka soyeux", "Montagne sacrée"],
  },
  {
    ...
    highlights: ["Forêt primaire", "Lémuriens noirs", "Boas de Madagascar"],
  },
  {
    ...
    highlights: ["Récifs coralliens", "Poissons tropicaux", "Snorkeling"],
  },
];

// Types de destinations disponibles
export const destinationTypes = [
  { value: "city", label: "Ville", icon: "🏙️" },
  { value: "island", label: "Île", icon: "🏝️" },
  { value: "park", label: "Parc National", icon: "🌳" },
  { value: "reserve", label: "Réserve", icon: "🦎" },
  { value: "nature", label: "Site Naturel", icon: "🏔️" },
  { value: "beach", label: "Plage", icon: "🏖️" },
  { value: "cultural", label: "Site Culturel", icon: "🎨" },
  { value: "marine", label: "Parc Marin", icon: "🐠" },
];
...
export const regions = [
  ...
  },
  {
    id: "nord",
    name: "Nord",
    description: "Diego Suarez, Nosy Be, mer émeraude",
    destinations: [
      "Diego Suarez",
      "Nosy Be",
      "Montagne d'Ambre",
  ...
  },
  {
    id: "sud-ouest",
    name: "Sud-Ouest",
    description: "Isalo, Tuléar, plages et culture Vezo",
    destinations: ["Isalo", "Tuléar", "Ifaty", "Anakao", "Berenty"],
  },
  {
    id: "sud-est",
    name: "Sud-Est",
  ...
  },
  {
    id: "nord-ouest",
    name: "Nord-Ouest",
    description: "Archipels et îles préservées",
    destinations: ["Nosy Mitsio", "Nosy Iranja"],
  },
  {
    id: "nord-est",
    name: "Nord-Est (SAVA)",
    description: "Vanille, parcs sauvages, côte préservée",
    destinations: ["Sambava", "Marojejy", "Vohémar", "Cap Masoala"],
  },
];

// // Fonction utilitaire pour filtrer par région
