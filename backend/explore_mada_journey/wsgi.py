...
# Middleware SANS CsrfViewMiddleware - TOTALEMENT RETIRÉ
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',
    'django.middleware.security.SecurityMiddleware',
    'django.contrib.sessions.middleware.SessionMiddleware',
    'django.middleware.common.CommonMiddleware',
    # 'django.middleware.csrf.CsrfViewMiddleware',  # SUPPRIMÉ
...
# Configuration CSRF désactivée (garder pour compatibilité mais sans effet)
CSRF_COOKIE_DOMAIN = '.madagascar-voyagesolidaire.com'
CSRF_COOKIE_SECURE = False  # Désactivé
CSRF_COOKIE_HTTPONLY = False  # Désactivé
CSRF_USE_SESSIONS = False  # Désactivé
...
if DEBUG:
    print("CSRF Protection: DISABLED via monkey patch")
