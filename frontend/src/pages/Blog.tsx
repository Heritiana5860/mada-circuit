...
const Blog = () => {
  ...
  const {
    ...
    errorPolicy: "all", // Permet de récupérer les données partielles même en cas d'erreur
    notifyOnNetworkStatusChange: true,
    fetchPolicy: "cache-and-network", // Utilise le cache mais rafraîchit les données
    onError: (error) => {
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Section Newsletter */}
            <div className="mt-20 bg-gradient-to-r from-green-500 to-blue-500 rounded-2xl p-8 lg:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                ...
                />
                <Button className="bg-white text-green-600 hover:bg-white/90 font-semibold px-8">
                  S'abonner
                </Button>
              </div>
            </div>
